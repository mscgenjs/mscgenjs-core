...
module.exports = {
  programASTPairs: [
    ...
    },
    {
      ...
      program:
        'msc { a,"b space"; a => "b space" [label="a simple script"];}//ignored',
      ast: fix.astSimple,
    },
    {
    ...
    },
    {
      ...
      program:
        'msc{--- [label="start"]; ... [label="no entities ..."]; ---[label="end"];}',
    ...
    },
    {
      ...
      program:
        'msc{HSCAle=1.2, widtH=800, ARCGRADIENT="17",woRDwrAParcS="oN";a;}',
      ast: fix.astOptionsMscgen,
    },
    {
      title: "should produce lowercase for upper/ mixed case attributes",
      program:
        'msc{a [LaBEL="miXed", teXTBGcolOR="orange"]; a NOte a [LINEcolor="red", TEXTColoR="blue", ArcSkip="4"];}',
      ast: fix.astMixedAttributes,
    },
    {
      title: "should translate *colour to *color",
      program:
        'msc { a [textcolOUr="green", textBGColour="cyan", linecolour="#ABCDEF"];}',
...
a <<=>> a [label="Label for a <<=>> a", idurl="http://localhost/idurl", id="Just and id", url="http://localhost/url", linecolor="#ABCDEF", textcolor="green", textbgcolor="cyan"];
    ...
    },
    {
      ...
      program:
        'msc {arcgradient="18"; "ω","ɑ","β","ɣ"; "ɑ" -> * [label="ɑ -> *"]; * <- "β" [label="* <- β"]; "ɣ" <-> * [label="ɣ <-> *"];}',
  ...
  syntaxErrors: [
    ...
    {
      title:
        "should throw a SyntaxError on a program with only the start token",
      program: "msc",
    },
    {
      title:
        "should throw a SyntaxError on a program with shizzle after the closing statement",
    ...
    {
      title:
        "should throw a SyntaxError on a missing closing bracket on an entity",
    ...
    {
      title:
        "should throw a SyntaxError on a missing closing bracket on an arc",
    ...
    {
      title:
        "should throw a SyntaxError when a keyword is used for an entity name",
    ...
    {
      title:
        "should throw a SyntaxError when passing a non-number like string to something expecting numbers",
    ...
    {
      title:
        "should throw a SyntaxError when passing a non boolean-like string to something expecting booleans",
