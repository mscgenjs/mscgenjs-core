...
describe("#geometry", () => {
  describe("#getDirection", () => {
    it("returns -1,1,1 for (10,0),(0,10)", () => {
      deepEqual(
        variationhelpers.getDirection({ xFrom: 10, yFrom: 0, xTo: 0, yTo: 10 }),
    ...
    it("returns -1,1,-Infinity for (0,0),(0,10)", () => {
      deepEqual(
        variationhelpers.getDirection({ xFrom: 0, yFrom: 0, xTo: 0, yTo: 10 }),
    ...
    it("returns -1,1,0 for (0,0),(10,0)", () => {
      deepEqual(
        variationhelpers.getDirection({ xFrom: 0, yFrom: 0, xTo: 10, yTo: 0 }),
