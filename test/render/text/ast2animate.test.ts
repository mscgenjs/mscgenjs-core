...
describe("render/text/ast2ani", () => {
  ...
  describe("#getFrame(getLength())", () => {
    ...
    it("should return astCheatSheet for astCheatSheet and length === somethingbig", () => {
  ...
  describe("#getFrame()", () => {
    ...
    it("should return entities and first arc from astCheatSheet for astCheatSheet", () => {
      deepEqual(ani.getFrame(1), astCheatSheet1);
    });

    it("should return entities and first three arcs from astCheatSheet for astCheatSheet", () => {
      deepEqual(ani.getFrame(3), astCheatSheet3);
    });

    it("should return entities and first two arcs from astCheatSheet for astCheatSheet", () => {
  ...
  describe("#home, #end, #inc, #dec, #getPosition, #getCurrentFrame #getPercentage", () => {
    ...
    it("getCurrentFrame should return astCheatSheet after call to end()", () => {
      ani.end();
      deepEqual(ani.getPosition(), 15);
      deepEqual(ani.getPercentage(), 100);
      deepEqual(ani.getCurrentFrame(), fix.astCheatSheet);
    });
    it("getCurrentFrame should return astCheatSheet1 after end() and 14 calls to dec()", () => {
      ani.end();
      ani.dec(14);
    ...
    it("getCurrentFrame should return astCheatSheet2 after call to home() and two calls to inc()", () => {
      ani.home();
      ani.inc(2);
    ...
    it("getCurrentFrame should return entities only after call to home()", () => {
      ani.home();
      ani.inc();
      ani.dec();
      deepEqual(ani.getPosition(), 0);
  ...
  describe("inline expressions", () => {
    ...
    it("getLength for inline expressions takes expression length into account", () => {
    ...
    it("produces the right frames - 0", () => {
      tst.assertequalToFileJSON(
        path.join(__dirname, "../../fixtures/xuframe00.json"),
        ani.getFrame(0),
      );
    });
    ...
    it("produces the right frames - 1", () => {
      tst.assertequalToFileJSON(
        path.join(__dirname, "../../fixtures/xuframe01.json"),
        ani.getFrame(1),
      );
    });
    ...
    it("produces the right frames - 2", () => {
      tst.assertequalToFileJSON(
        path.join(__dirname, "../../fixtures/xuframe02.json"),
        ani.getFrame(2),
      );
    });
