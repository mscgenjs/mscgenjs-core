...
(function(root, factory) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$e93 = peg$literalExpectation("0", false);
    var peg$e94 = peg$literalExpectation("1", false);
    ...
    var peg$f7 = function(el) {
          return el[0].concat(el[1]);
        };
    var peg$f8 = function(name, a) {return a};
    var peg$f9 = function(name, attrList) {
                return _assign ({name:name}, attrList);
            };
    var peg$f10 = function(name, attrList) {
    ...
    var peg$f12 = function(al) {
           return al[0].concat(al[1]);
        };
    var peg$f13 = function(a, al) {return al};
    var peg$f14 = function(a, al) {
          return _assign (a, al);
        };
    var peg$f15 = function(kind) {return {kind:kind}};
    var peg$f16 = function(from, kind, to) {return {kind: kind, from:from, to:to}};
    var peg$f17 = function(kind, to) {return {kind:kind, from: "*", to:to}};
    var peg$f18 = function(from, kind) {return {kind:kind, from: from, to:"*"}};
    var peg$f19 = function(kind) {return kind.toLowerCase()};
    var peg$f20 = function(attributes) {
    ...
    var peg$f22 = function(s) {return s.join("")};
    var peg$f23 = function(c) {return c};
    var peg$f24 = function(letters) {return letters.join("")};
    var peg$f25 = function(start, com, end) {
          return start + com.join("") + end
        };
    var peg$f26 = function(start, com) {
          return start + com.join("")
        };
    var peg$f27 = function(s) { return s; };
    var peg$f28 = function(i) { return i.toString(); };
    var peg$f29 = function(s) { return s.toString(); };
    var peg$f30 = function(digits) { return parseInt(digits.join(""), 10); };
    var peg$f31 = function(digits) { return parseFloat(digits.join("")); };
    var peg$f32 = function(bs) {return bs;};
    var peg$f33 = function(b) {return b.toString();};
    ...
    function peg$parseoption() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$currPos;
        s1 = peg$parse_();
        if (input.substr(peg$currPos, 12).toLowerCase() === peg$c9) {
                          ...
                          if (s0 === peg$FAILED) {
                            ...
                            if (s0 === peg$FAILED) {
                              ...
                              if (s0 === peg$FAILED) {
                                ...
                                if (s0 === peg$FAILED) {
                                  if (input.substr(peg$currPos, 14).toLowerCase() === peg$c55) {
                                  ...
                                  if (s0 === peg$FAILED) {
                                    if (input.substr(peg$currPos, 15).toLowerCase() === peg$c56) {
