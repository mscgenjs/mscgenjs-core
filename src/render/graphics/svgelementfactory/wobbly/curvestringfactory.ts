...
export function renderNotePathString(pBBox: IBBox, pFoldSize: number): string {
  return (
...
export function abox2CurveString(pBBox: IBBox, pSlopeOffset: number): string {
  return (
...
export function doubleLine2CurveString(pLine: ILine, pOptions): string {
