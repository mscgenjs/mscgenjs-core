...
(function (root, factory) {
	...
	function peg$parse(input, options) {
		...
		var peg$e117 = peg$otherExpectation("size");
		var peg$e118 = peg$literalExpectation("auto", true);
		...
		var peg$f25 = function (a, al) {
			return al;
		};
		var peg$f26 = function (a, al) {
			return { ...a, ...al };
		};
		var peg$f27 = function (kind) {
			return { kind: kind };
		};
		var peg$f28 = function (kind) {
			return { kind: kind };
		};
		var peg$f29 = function (from, kind, to) {
			return { kind: kind, from: from, to: to };
		};
		var peg$f30 = function (kind, to) {
			return { kind: kind, from: "*", to: to };
		};
		var peg$f31 = function (from, kind) {
			return { kind: kind, from: from, to: "*" };
		};
		var peg$f32 = function (from, kind) {
			return { kind: kind, from: from, to: "*" };
		};
		var peg$f33 = function (from, kind, to, al) {
			return al;
		};
		var peg$f34 = function (from, kind, to, al, arclist) {
			return { kind: kind, from: from, to: to, arcs: arclist, ...al };
		};
		var peg$f35 = function (kind) {
		...
		var peg$f55 = function (bs) {
			return bs;
		};
		var peg$f56 = function (b) {
			return b.toString();
		};
