...
(function (root, factory) {
	...
	function peg$parse(input, options) {
		...
		var peg$f19 = function (a) {
			return a;
		};
		var peg$f20 = function (a) {
			return a;
		};
		var peg$f21 = function (a, al) {
			return al;
		};
		var peg$f22 = function (a, al) {
			return { ...a, ...al };
		};
		var peg$f23 = function (kind) {
			return { kind: kind };
		};
		var peg$f24 = function (kind) {
			return { kind: kind };
		};
		var peg$f25 = function (from, kind, to) {
			return { kind: kind, from: from, to: to };
		};
		var peg$f26 = function (kind, to) {
			return { kind: kind, from: "*", to: to };
		};
		var peg$f27 = function (from, kind) {
			return { kind: kind, from: from, to: "*" };
		};
		var peg$f28 = function (from, kind) {
			return { kind: kind, from: from, to: "*" };
		};
		var peg$f29 = function (kind) {
			return kind.toLowerCase();
		};
		var peg$f30 = function (a) {
			return a;
		};
		var peg$f31 = function (a) {
			return a;
		};
