...
(function (root, factory) {
	...
	function peg$parse(input, options) {
		...
		function peg$f10(name, a) {
			return a;
		}
		function peg$f11(name, attrList) {
			return { name: name, ...attrList };
		}
		function peg$f12(name, a) {
			return a;
		}
		function peg$f13(name, attrList) {
			if (parserHelpers.isMscGenKeyword(name)) {
				error(
					"Keywords aren't allowed as entity names (embed them in quotes if you need them)",
				);
			}
			return { name: name, ...attrList };
		}
		...
		function peg$f21(a, al) {
			return al;
		}
		function peg$f22(a, al) {
			return { ...a, ...al };
		}
		function peg$f23(kind) {
			return { kind: kind };
		}
		function peg$f24(kind) {
			return { kind: kind };
		}
		function peg$f25(from, kind, to) {
			return { kind: kind, from: from, to: to };
		}
		function peg$f26(kind, to) {
			return { kind: kind, from: "*", to: to };
		}
		function peg$f27(from, kind) {
			return { kind: kind, from: from, to: "*" };
		}
		function peg$f28(from, kind) {
			return { kind: kind, from: from, to: "*" };
		}
		function peg$f29(kind) {
