...
function bootstrap(pWindow, pParentElement, pSvgElementId, pMarkerDefs, pOptions) {
    ...
    var lSkeletonSvg = index_1["default"].createSVG(pSvgElementId, pSvgElementId, distillRenderMagic(pOptions));
...
function setupDesc(pWindow, pSource) {
    var lDesc = index_1["default"].createDesc();
